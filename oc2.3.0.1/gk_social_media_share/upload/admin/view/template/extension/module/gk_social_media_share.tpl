    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-gk-social-media-share" data-toggle="tooltip"
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                      id="form-gk-social-media-share" class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><?php echo $app_id; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="facebook[app_id]" placeholder="<?php echo $entry_app_id_name; ?>"
                                   value="<?php echo $social_data['facebook']['app_id']; ?>" id="input-name"
                                   class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="facebook[app_secret]" placeholder="<?php echo $entry_app_secret_name; ?>"
                                   id="input-name" class="form-control"
                                   value="<?php echo $social_data['facebook']['app_secret']; ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="checkbox" value="1"
                                   name="facebook[share_fb]"<?php if ( isset( $social_data['facebook']['share_fb'] ) && $social_data['facebook']['share_fb'] == '1' ) {
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="checkbox" value="1"
                                   name="facebook[share_add]"<?php if ( isset( $social_data['facebook']['share_add'] ) && $social_data['facebook']['share_add'] == '1' ) {
                                echo ' checked="checked"';
                            } ?> />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="checkbox" value="1"
                                   name="facebook[share_edit]"<?php if ( isset( $social_data['facebook']['share_edit'] ) && $social_data['facebook']['share_edit'] == '1' ) {
                                echo ' checked="checked"';
                            } ?> />
                        </div>
                    </div>
                    ...
                    if ( ( strtolower( $social_data['facebook']['app_secret'] ) != 'app secret' ) && ( strtolower( $social_data['facebook']['app_id'] ) != 'app id' ) && isset( $fb_login_url ) ) {
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="hidden" name="facebook[page_id]"
                                       value="<?php echo $social_data['facebook']['page_id']; ?>"/>
                                <input type="hidden" name="facebook[page_access_token]"
                                       value="<?php echo $social_data['facebook']['page_access_token']; ?>"/>
                                <input type="hidden" name="facebook[page_name]"
                                       value="<?php echo $social_data['facebook']['page_name']; ?>"/>
                                <input type="hidden" name="facebook[user]"
                                       value="<?php echo $social_data['facebook']['user']; ?>"/>
                                <div class="text-info"><?php echo $fb_selected_page_text; ?></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-12 control-label"><a
                                        href="<?php echo $fb_logout_url; ?>"><?php echo $fb_logout_text; ?></a></label>
                        </div>
                        <?php
                    }
                    ?>
